...
- ### in Code Squad
  ...
  >
  >   - 다형성에 대한 이해를 위한 콘솔 프로젝트
  >
  > - [JSON 문자열 분석기](https://github.com/O-O-wl/swift-jsonparser)
  >
  >   - JSON 컨테이너에 대한 이해를 위한 프로젝트
  >
  > - [카드 게임](https://github.com/O-O-wl/swift-cardgame)
  >
  >   - 플레이어들의 private한  카드패 속성으로 승패 비교하는 방법 구현 
  >
  > - [음료 자판기](https://github.com/O-O-wl/swift--vendingmachine)
  >
  >   - 클로저 주입을 통한 데이터 핸들링 구현
  >
  >   - strategy pattern 으로 실행 메뉴를 구현하여, 추후 실행 메뉴 확장을 쉽게 할 수 있게 구현(OCP)
  >
  >     
  >
  > ---
  ...
  >
  >   - NSCoding 을 이용한 객체 그래프 아카이빙 구현
  >   - 클로저 주입을 통한 데이터 핸들링 구현
  >   - 음료자판기 콘솔 소스의 뷰를  분리하여 , iOS 프로젝트에서 기존 소스 재사용
  >   - NotificationCenter를 이용하여, 객체 언아카이빙 시점과 뷰 업데이트 시점의 불일치 해결
  >   - <img width="1680" alt="스크린샷 2019-11-03 오후 8 05 58" src="https://user-images.githubusercontent.com/39197978/70319112-e110eb00-1864-11ea-9b42-79ff03579e57.png">
  >
  > - [연락처 앱](https://github.com/O-O-wl/addressbook-app)
  >
  >   - MVVM 아키텍처
  >   - 클로저 주입과 프로퍼티 옵저버를 이용하여, 뷰모델에서의 fetch 와 시점과 뷰 업데이트 시점의 불일치 해결
  >   - Unicode 정규화 연습 - 초성으로 연락처 필터링 구현
  >
  >   <img width="242" alt="스크린샷 2019-12-06 오후 8 17 03" src="https://user-images.githubusercontent.com/39197978/70319342-698f8b80-1865-11ea-9ee8-8f72f2192489.png">
  >   <img width="242" alt="스크린샷 2019-12-06 오후 8 17 12" src="https://user-images.githubusercontent.com/39197978/70319344-698f8b80-1865-11ea-99dd-545dace67d4e.png">
  >
  > - [스토어 앱](https://github.com/O-O-wl/store-app)
